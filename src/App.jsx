...
const SCENE_NAMES = ['mountainClimb','targetHit','bridge','seedToTree','lighthouse','teamCircle','ladder','compass','figureThinking','figureCelebrate','doorOpen','puzzleFit'];
...
const ICON_NAMES = ['idea','heart','star','checkmark','target','flag','rocket','clock','speech','growth','person','exclamation','question','document','loop'];
...
Erste 4-5 Sektionen=Hauptstory,Rest=Werkzeugkasten. 7-9 Sektionen,2-3 kurze Stichpunkte(max 28Z!),Titel max 22Z,mind.4 mit scene,Deutsch`;
  let sys,usr;
